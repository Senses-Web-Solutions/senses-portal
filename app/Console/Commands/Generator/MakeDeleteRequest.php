...
class MakeDeleteRequest extends GeneratorCommand
{
    protected $name = 'make:senses_delete_request';

    protected $description = 'Create a new delete request';

    protected $type = 'Delete Request';

    protected function getStub(): string
    {
        return $this->resolveStubPath('/stubs/generator/delete-request.stub');
    }
    ...
    {
        $permissions = "\t\t" . 'if (getCurrentUser()?->can(\'delete-' . $this->option('model') .'\')) {' . PHP_EOL . "\t\t\t" . 'return true;' . PHP_EOL . "\t\t" . '}';
