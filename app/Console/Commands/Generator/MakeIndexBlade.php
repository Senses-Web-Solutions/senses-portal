...
class MakeIndexBlade extends GeneratorCommand
{
    protected $name = 'make:senses_index_blade';

    protected $description = 'Create a new index blade file';

    protected $type = 'Index Blade';

    protected function getStub(): string
    {
        return $this->resolveStubPath('/stubs/generator/index-blade.stub');
    }
    ...
    protected function getPath($name): string
    {
        ...
        return "{$this->laravel['path']}/../resources/views/$fileName";
    }
}
