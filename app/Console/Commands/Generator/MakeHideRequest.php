...
class MakeHideRequest extends GeneratorCommand
{
    protected $name = 'make:senses_hide_request';

    protected $description = 'Create a new hide request';

    protected $type = 'Hide Request';

    protected function getStub(): string
    {
        return $this->resolveStubPath('/stubs/generator/hide-request.stub');
    }
    ...
    {
        $permissions = "\t\t" . 'if (getCurrentUser()?->can(\'hide-' . $this->option('model') .'\')) {' . PHP_EOL . "\t\t\t" . 'return true;' . PHP_EOL . "\t\t" . '}';
