...
class MakeGenerateShowCacheAction extends GeneratorCommand
{
    protected $name = 'make:senses_generate_show_cache_action';

    protected $description = 'Create a new generate show cache action';

    protected $type = 'Generate Show Cache Action';

    protected function getStub(): string
    {
        return $this->resolveStubPath('/stubs/generator/generate-show-cache-action.stub');
    }
