...
class MakeDeleteAction extends GeneratorCommand
{
    protected $name = 'make:senses_delete_action';

    protected $description = 'Create a new delete action';

    protected $type = 'Delete Action';

    protected function getStub(): string
    {
        return $this->resolveStubPath('/stubs/generator/delete-action.stub');
    }
