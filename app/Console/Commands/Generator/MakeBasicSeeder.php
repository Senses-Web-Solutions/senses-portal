...
class MakeBasicSeeder extends GeneratorCommand
{
    protected $name = 'make:senses_basic_seeder';

    protected $description = 'Create a new basic seeder';

    protected $type = 'Basic Seeder';

    protected function getStub(): string
    {
        return $this->resolveStubPath('/stubs/generator/basic-seeder.stub');
    }
    ...
    protected function buildUsingJson(&$stub)
    {
        ...
        $stub = str_replace(['{{ seederNumber }}', '{{seederNumber}}'], $jsonData['seeder'], $stub);
    }
    ...
    protected function getPath($name): string
    {
        ...
        return "{$this->laravel['path']}/../database/seeders/Basic/$fileName";
    }
}
