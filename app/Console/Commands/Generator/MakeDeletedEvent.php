...
class MakeDeletedEvent extends GeneratorCommand
{
    protected $name = 'make:senses_deleted_event';

    protected $description = 'Create a new deleted event';

    protected $type = 'Deleted Event';

    protected function getStub(): string
    {
        return $this->resolveStubPath('/stubs/generator/deleted-event.stub');
    }
    ...
    protected function getPath($name): string
    {
        ...
        return "{$this->laravel['path']}/../app/Events/$fileName";
    }
}
