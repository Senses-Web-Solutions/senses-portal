...
class MakeUpdatedEvent extends GeneratorCommand
{
    protected $name = 'make:senses_updated_event';

    protected $description = 'Create a new updated event';

    protected $type = 'Updated Event';

    protected function getStub(): string
    {
        return $this->resolveStubPath('/stubs/generator/updated-event.stub');
    }
