...
class MakeBrowserTest extends GeneratorCommand
{
    protected $name = 'make:senses_browser_test';

    protected $description = 'Create a new browser test';

    protected $type = 'Test';

    protected function getStub(): string
    {
        return $this->resolveStubPath('/stubs/generator/browser-test.stub');
    }
    ...
    protected function getPath($name): string
    {
        ...
        return "{$this->laravel['path']}/../tests/Browser/$fileName";
    }
}
