...
class MakeUpdateAction extends GeneratorCommand
{
    protected $name = 'make:senses_update_action';

    protected $description = 'Create a new update action';

    protected $type = 'Update Action';

    protected function getStub(): string
    {
        return $this->resolveStubPath('/stubs/generator/update-action.stub');
    }
