...
class MakeShowBlade extends GeneratorCommand
{
    protected $name = 'make:senses_show_blade';

    protected $description = 'Create a new show blade file';

    protected $type = 'Show Blade';

    protected function getStub(): string
    {
        return $this->resolveStubPath('/stubs/generator/show-blade.stub');
    }
