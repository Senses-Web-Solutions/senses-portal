...
class MakeCreatedEvent extends GeneratorCommand
{
    protected $name = 'make:senses_created_event';

    protected $description = 'Create a new created event';

    protected $type = 'Created Event';

    protected function getStub(): string
    {
        return $this->resolveStubPath('/stubs/generator/created-event.stub');
    }
