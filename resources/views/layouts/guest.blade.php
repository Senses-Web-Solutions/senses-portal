...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="@yield('body-class') bg-gradient-to-br from-sky-100 dark:from-gray-50 via-yellow-50 to-primary-200 dark:via-zinc-50 dark:to-primary-50 h-screen guest-page" :class="window.getCookie('theme')">
