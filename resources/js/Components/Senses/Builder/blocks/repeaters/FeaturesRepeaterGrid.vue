                ...
                <div v-for="feature in content?.features">
                    <div class="bg-white rounded-2xl shadow-lg hover:shadow-2xl">
                        <div class="flex-1 relative pt-16 px-6 pb-8 md:px-8">
                            <div class="absolute top-0 p-5 inline-block rounded-xl shadow-lg transform -translate-y-1/2" :class="'bg-' + feature.content.icon_bg_colour">
                            ...
                            <p v-html="nl2br(feature.content.paragraph, true)" class="mt-4 text-base text-zinc-500 overflow-hidden" style="height: 150px;" />
                        </div>
...
export default defineComponent({
    ...
    block: defineBlock({
        name: 'repeaters.features-repeater',
