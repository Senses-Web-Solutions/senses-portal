    ...
    <Block
        ...
        <div class="focus:outline-none">
            <div class="grid grid-cols-4 gap-6">
                ...
                <InternalDrop v-model="content.col4" :key="blockKey" :is-editor="true"></InternalDrop>
            </div>
        </div>
    </Block>
</template>
...
import FourEqualColumnsIcon from '../../icons/svg/layouts-four-equal-cols.svg?raw';

export default defineComponent({
    components: { Block, InternalDrop },
    mixins: [BlockMixin],
    block: defineBlock({
        name: 'layouts.four-equal-columns',
        displayName: 'Four Equal Columns',
        icon: FourEqualColumnsIcon,
        categories: ['layouts'],
        defaultContent: {
            width: 'standard',
            bottom_space: 'small',
