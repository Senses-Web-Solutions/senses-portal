<template>
    <Block class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8"
        ...
        <div class="max-w-3xl mx-auto lg:max-w-7xl px-4 sm:px-6 lg:px-8" :class="{
            ...
            <TextNode basic
                class="pointer inline-block px-6 py-3 border border-blue-300 text-base font-medium rounded-md shadow-sm text-zinc-700 bg-white hover:bg-blue-200 transition-colors focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-purple-500"
...
import Icon from '../../icons/svg/buttons/buttons-light.svg?raw';
